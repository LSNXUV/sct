...
const AddComponent = () => {
    ...
    const onFinish =async (values: StudentType &{
        ...
        const res = await Student.save(values)
        if(res.code === 0){
    ...
    return (
        ...
        >
            <Card hoverable title={<Title level={2}>添加学生</Title>}
                style={{
                    width: '600px',
                    padding: 24,
                    margin: 'auto',
            ...
            >
                <Form 
                    ...
                    size={'large'}
                >
                    <Form.Item<StudentType> label="姓名" name={"name"}
                        rules={[
                            {
                                required: true,
                                message: '请输入姓名!',
                    ...
                    <Form.Item<StudentType> label="学号" name={"id"}
                        rules={[
                            {
                                type: 'number',
                                message: '请输入数字',
                    ...
                    <Form.Item<StudentType> label="年龄" name={"age"}
                        rules={[
                            {
                                type: 'number',
                                message: '请输入数字',
                    ...
                    <Form.Item<StudentType> label="性别" name={"gender"}
                        rules={[
                            {
                                required: true,
                                message: '请选择性别!',
                    ...
                    <Form.Item<StudentType> label="专业" name={"major"}
                        rules={[
                            {
                                required: true,
                                message: '请输入专业!',
                    ...
                    <Form.Item<StudentType> label="电话" name={"phone"}
                        rules={[
                            {
                                required: true,
                                message: '请输入电话号码!',
                    ...
                    <Form.Item<StudentType> label="邮箱" name={"email"}
                        rules={[
                            {
                                required: true,
                                message: '请输入邮箱!',
...
function AddPage() {
    return (
        <FLayout>
            <CusMenu SelectKey='22' OpenSubKey={['2']} />
            <AddComponent />
        </FLayout>
    )
}
